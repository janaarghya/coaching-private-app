...
<style>
  ...
  /* Hide deploy button, decoration — keep header so mobile hamburger works */
  ...
  /* Desktop: collapse header height so it takes no space */
  @media (min-width: 769px) {
    header[data-testid="stHeader"] { height: 0 !important; min-height: 0 !important; overflow: hidden; }
  }
  /* Mobile: keep header visible for the hamburger toggle */
  ...
  /* Hide the radio dot — keep the full clickable row */
  ...
  /* Selected radio item — emerald pill */
